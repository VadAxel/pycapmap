...
def start_graphic():
    ...
    startup_layout = [
        ...
        [sg.Push(), sg.Button("Start - Plain", size=(14, 2), font=("Helvetica", 14)),sg.Button("Start - Extensive", size=(14, 2), font=("Helvetica", 14)), sg.Push()],
        [sg.Push(), sg.Button("Exit", size=(14, 2), font=("Helvetica", 14)), sg.Push()]
    ]
